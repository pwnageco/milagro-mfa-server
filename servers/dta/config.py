...
credentialsFile = os.path.abspath(os.path.join(full_path,"../../credentials.json"))
#credentialsFile = "/home/yan/milagro-mfa-server/credentials.json"
...
"""
# backup = False
backup_file = os.path.abspath(os.path.join(full_path,"../../backup_dta.json"))
#backup_file = "/home/yan/milagro-mfa-server/backup_dta.json"
# encrypt_master_secret = False
passphrase = "HelloWorld"
salt = unicode(os.urandom(8).encode('hex'))
